...
class Penerimaan extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['can_create'] = $this->check_permission('daftar/penerimaan', 'create');
        $this->data['can_edit'] = $this->check_permission('daftar/penerimaan', 'edit');
        $this->data['can_delete'] = $this->check_permission('daftar/penerimaan', 'delete');
    ...
    {
        $data['extra_js'] = 'daftar/penerimaan/script';
        if (!$this->check_permission('daftar/penerimaan', 'create')) {
            $this->session->set_flashdata('error', 'Anda tidak memiliki izin untuk membuat penerimaan barang!');
            return redirect('daftar/penerimaan');
        }
        ...
        if ($this->form_validation->run() === FALSE) {
            return $this->render_view('daftar/penerimaan/form', $data);
        }
        ...
        return redirect('daftar/penerimaan/tambah');
    }
    ...
    public function edit($id_penerimaan)
    {
        ...
        if (!$this->check_permission('daftar/penerimaan', 'edit')) {
        ...
        return redirect('daftar/penerimaan/edit/' . $id_penerimaan);
    }

    public function hapus($id_penerimaan)
    {
        if (!$this->check_permission('daftar/penerimaan', 'delete')) {
