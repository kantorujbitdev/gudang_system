...
class Retur_penjualan extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['can_create'] = $this->check_permission('daftar/retur_penjualan', 'create');
        $this->data['can_edit'] = $this->check_permission('daftar/retur_penjualan', 'edit');
        $this->data['can_delete'] = $this->check_permission('daftar/retur_penjualan', 'delete');
    ...
    {
        if (!$this->check_permission('daftar/retur_penjualan', 'create')) {
            $this->session->set_flashdata('error', 'Anda tidak memiliki izin untuk membuat retur penjualan!');
            return redirect('daftar/retur_penjualan');
        }
        ...
        $this->data['extra_js'] = 'daftar/retur_penjualan/script';
        ...
        if ($this->form_validation->run() === FALSE) {
            return $this->render_view('daftar/retur_penjualan/form', $this->data);
        }
    ...
    {
        if (!$this->check_permission('daftar/retur_penjualan', 'edit')) {
        ...
        if ($this->form_validation->run() === FALSE) {
            return $this->render_view('daftar/retur_penjualan/verifikasi', $this->data);
        }
    ...
    {
        if (!$this->check_permission('daftar/retur_penjualan', 'delete')) {
