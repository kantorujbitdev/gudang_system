...
class Pemindahan extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['can_create'] = $this->check_permission('daftar/pemindahan', 'create');
        $this->data['can_edit'] = $this->check_permission('daftar/pemindahan', 'edit');
        $this->data['can_delete'] = $this->check_permission('daftar/pemindahan', 'delete');
    ...
    {
        $data['extra_js'] = 'daftar/pemindahan/pemindahan_script';
        if (!$this->check_permission('daftar/pemindahan', 'create')) {
            $this->session->set_flashdata('error', 'Anda tidak memiliki izin untuk membuat pemindahan barang!');
            return redirect('daftar/pemindahan');
        }
        ...
        if ($this->form_validation->run() == FALSE) {
            return $this->render_view('daftar/pemindahan/form', $data);
        }
        ...
        if ($tipe_tujuan == 'gudang') {
            ...
            if ($id_gudang_asal == $id_gudang_tujuan) {
                ...
                return redirect('daftar/pemindahan/tambah');
            }
    ...
    public function edit($id_pemindahan)
    {
        ...
        if (!$this->check_permission('daftar/pemindahan', 'edit')) {
        ...
        if ($tipe_tujuan == 'gudang') {
            ...
            if ($id_gudang_asal == $id_gudang_tujuan) {
                $this->session->set_flashdata('error', 'Gudang asal dan tujuan tidak boleh sama!');
                return redirect('daftar/pemindahan/edit/' . $id_pemindahan);
            }
