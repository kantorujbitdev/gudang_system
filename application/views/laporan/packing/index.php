                    ...
                    <div class="col-md-6">
                        <div class="card bg-primary text-white">
                            <div class="card-body">
                                ...
                                <h3 class="card-text">
                                    <?php echo $this->packing->get_summary($filter)->total_packing ?: 0; ?>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card bg-success text-white">
                            <div class="card-body">
                                ...
                                <h3 class="card-text">
                                    <?php echo $this->packing->get_summary($filter)->total_barang ?: 0; ?>
                                </h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Total Packing</th>
                                        <th>Total Barang</th>
                                        <th>Rata-rata Barang/Packing</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($this->packing->get_packing_by_user($filter) as $row): ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $row->nama; ?></td>
                                            <td><?php echo $row->total_packing; ?></td>
                                            <td><?php echo $row->total_barang; ?></td>
                                            <td><?php echo $row->total_packing > 0 ? round($row->total_barang / $row->total_packing, 2) : 0; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
