<div class="form-group text-left mt-4">
    <?php echo back_button('setup/user/packing'); ?>
</div>
<div class="card shadow mb-4">
    <div class="card-header bg-primary text-white d-flex align-items-center">
        <?php echo responsive_title('Tambah Admin Packing') ?>
    </div>
    <div class="card-body px-4 py-4">
        <?php echo form_open_multipart('setup/user/tambah_packing'); ?>
        ...
        <div class="form-group">
            ...
            <a href="<?php echo site_url('setup/user/packing'); ?>" class="btn btn-secondary">Batal</a>
        </div>
        <?php echo form_close(); ?>
    </div>
</div>
