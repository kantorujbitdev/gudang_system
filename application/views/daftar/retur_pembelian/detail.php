    ...
    <div class="card-header py-3">
        <div class="row">
            ...
            <div class="col text-right">
                <a href="<?php echo site_url('daftar/retur_pembelian'); ?>" class="btn btn-secondary btn-sm">
                    <i class="fas fa-arrow-left"></i> Kembali
                </a>
                <a href="<?php echo site_url('daftar/retur_pembelian/cetak/' . $retur->id_retur_beli); ?>"
