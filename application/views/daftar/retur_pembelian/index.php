<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="row">
            <div class="col">
                <?php echo responsive_title_blue('Daftar Retur Pembelian') ?>
            </div>
    ...
    <div class="card-body">
        ...
        <div class="collapse <?php echo $this->input->post() ? 'show' : ''; ?>" id="filterCollapse">
            <div class="card card-body mb-4">
                <?php echo form_open('daftar/retur_pembelian/filter'); ?>
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <a href="<?php echo site_url('daftar/retur_pembelian'); ?>" class="btn btn-secondary">Reset</a>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
                    ...
                    foreach ($retur as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo site_url('daftar/retur_pembelian/cetak/' . $row->id_retur_beli); ?>"
