                ...
                <tbody>
                    ...
                    foreach ($pemindahan as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('daftar/pemindahan/detail/' . $row->id_pemindahan); ?>"
                                    class="btn btn-sm btn-info" title="Detail">
                                    <i class="fas fa-info-circle"></i>
                                </a>

                                <?php // Tombol Edit - hanya untuk status Draft dan user yang memiliki hak edit ?>
                                <?php if ($row->status == 'Draft' && $this->auth->has_permission('daftar/pemindahan', 'edit')): ?>
                                    <a href="<?php echo site_url('daftar/pemindahan/edit/' . $row->id_pemindahan); ?>"
                                ...
                                <?php if (
                                    ...
                                    $this->auth->has_permission('daftar/pemindahan', 'edit')
                                ): ?>
                                    <a href="<?php echo site_url('daftar/pemindahan/konfirmasi/' . $row->id_pemindahan . '/Packing'); ?>"
                                ...
                                <?php if (
                                    ...
                                    <a href="<?php echo site_url('daftar/pemindahan/konfirmasi/' . $row->id_pemindahan . '/Shipping'); ?>"
                                ...
                                <?php if (
                                    ...
                                    <a href="<?php echo site_url('daftar/pemindahan/konfirmasi/' . $row->id_pemindahan . '/Delivered'); ?>"
                                ...
                                <?php if (
                                    ...
                                    <a href="<?php echo site_url('daftar/pemindahan/konfirmasi/' . $row->id_pemindahan . '/Cancelled'); ?>"
