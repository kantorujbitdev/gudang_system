<script>
    $(document).ready(function () {
        ...
        <?php if ($this->session->userdata('id_role') == 1): ?>
            $('#id_perusahaan').change(function () {
                ...
                if (id_perusahaan) {
                    ...
                    $.ajax({
                        url: '<?php echo site_url('daftar/pemindahan/get_data_by_perusahaan'); ?>',
                        method: 'POST',
                        data: {
        ...
        $('#id_pelanggan').change(function () {
            ...
            if (id_pelanggan) {
                $.ajax({
                    url: '<?php echo site_url('daftar/pemindahan/get_alamat_pelanggan'); ?>',
                    method: 'POST',
                    data: {
        ...
        $('#id_gudang_asal').change(function () {
            ...
            if (id_gudang) {
                ...
                $.ajax({
                    url: '<?php echo site_url('daftar/pemindahan/get_barang_by_gudang'); ?>',
                    method: 'POST',
                    data: {
                        id_gudang: id_gudang,
                        <?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo $this->security->get_csrf_hash(); ?>'
