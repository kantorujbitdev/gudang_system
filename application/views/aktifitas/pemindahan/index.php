                ...
                <tbody>
                    ...
                    foreach ($pemindahan as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('aktifitas/pemindahan/detail/' . $row->id_transfer); ?>"
                                    class="btn btn-sm btn-info" title="Detail">
                                    <i class="fas fa-info-circle"></i>
                                </a>
                                <?php if ($row->status == 'Draft' && $can_edit): ?>
                                    <a href="<?php echo site_url('aktifitas/pemindahan/edit/' . $row->id_transfer); ?>"
                                        class="btn btn-sm btn-warning" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if ($row->status == 'Draft' && $can_delete): ?>
                                    <a href="<?php echo site_url('aktifitas/pemindahan/hapus/' . $row->id_transfer); ?>"
                                ...
                                <?php if ($can_edit): ?>
                                    <?php if ($row->status == 'Draft'): ?>
                                        <a href="<?php echo site_url('aktifitas/pemindahan/konfirmasi/' . $row->id_transfer . '/Packing'); ?>"
                                    ...
                                    <?php elseif ($row->status == 'Packing'): ?>
                                        <a href="<?php echo site_url('aktifitas/pemindahan/konfirmasi/' . $row->id_transfer . '/Shipping'); ?>"
                                    ...
                                    <?php elseif ($row->status == 'Shipping'): ?>
                                        <a href="<?php echo site_url('aktifitas/pemindahan/konfirmasi/' . $row->id_transfer . '/Delivered'); ?>"
                                    ...
                                    <?php if ($row->status != 'Delivered' && $row->status != 'Cancelled'): ?>
                                        <a href="<?php echo site_url('aktifitas/pemindahan/konfirmasi/' . $row->id_transfer . '/Cancelled'); ?>"
